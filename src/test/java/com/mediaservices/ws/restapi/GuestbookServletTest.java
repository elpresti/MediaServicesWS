...
package com.mediaservices.ws.restapi;
...
public class GuestbookServletTest {
  ...
  public void testDoGet() throws IOException {
    ...
    assertEquals("Hello! (from a Java class), " + currentUser.getNickname() + System.getProperty("line.separator"), stringWriter.toString());
  }
